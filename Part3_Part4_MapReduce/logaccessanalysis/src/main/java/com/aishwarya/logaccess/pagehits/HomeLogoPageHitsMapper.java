...
public class HomeLogoPageHitsMapper extends Mapper<LongWritable, Text, Text, IntWritable> {
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        if (s.trim().length() != 0) {
            ...
            if (webSiteItem.equalsIgnoreCase(context.getConfiguration().get("webSiteItem"))) {
